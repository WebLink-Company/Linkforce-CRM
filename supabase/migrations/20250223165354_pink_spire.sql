-- Create schema-specific functions for monthly income
CREATE OR REPLACE FUNCTION public_get_monthly_income(
  p_year integer,
  p_month integer
)
RETURNS json
...
CREATE OR REPLACE FUNCTION qalinkforce_get_monthly_income(
  p_year integer,
  p_month integer
)
RETURNS json
...
CREATE OR REPLACE FUNCTION quimicinter_get_monthly_income(
  p_year integer,
  p_month integer
)
RETURNS json
...
-- Create schema-specific functions for invoice payment stats
CREATE OR REPLACE FUNCTION public_get_invoice_payment_stats(
  p_year integer,
  p_month integer
)
RETURNS json
...
CREATE OR REPLACE FUNCTION qalinkforce_get_invoice_payment_stats(
  p_year integer,
  p_month integer
)
RETURNS json
...
CREATE OR REPLACE FUNCTION quimicinter_get_invoice_payment_stats(
  p_year integer,
  p_month integer
)
RETURNS json
...
GRANT EXECUTE ON FUNCTION public_get_monthly_income(integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION qalinkforce_get_monthly_income(integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION quimicinter_get_monthly_income(integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public_get_invoice_payment_stats(integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION qalinkforce_get_invoice_payment_stats(integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION quimicinter_get_invoice_payment_stats(integer, integer) TO authenticated;