-- Drop existing schema-specific functions
DROP FUNCTION IF EXISTS public_get_monthly_income(integer, integer);
DROP FUNCTION IF EXISTS qalinkforce_get_monthly_income(integer, integer);
DROP FUNCTION IF EXISTS quimicinter_get_monthly_income(integer, integer);
DROP FUNCTION IF EXISTS public_get_invoice_payment_stats(integer, integer);
DROP FUNCTION IF EXISTS qalinkforce_get_invoice_payment_stats(integer, integer);
DROP FUNCTION IF EXISTS quimicinter_get_invoice_payment_stats(integer, integer);

-- Restore original functions in each schema
...
-- Create same function in quimicinter schema
...
-- Create same function in qalinkforce schema
...
-- Restore get_invoice_payment_stats function in each schema
...
GRANT EXECUTE ON FUNCTION get_monthly_income(integer, integer) TO authenticated;
...
GRANT EXECUTE ON FUNCTION get_invoice_payment_stats(integer, integer) TO authenticated;
